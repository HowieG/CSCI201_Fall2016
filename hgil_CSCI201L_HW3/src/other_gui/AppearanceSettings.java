...
public class AppearanceSettings
{
	...
	//sets size of components
	@SafeVarargs
	public static <T extends JComponent> void setMaxSize(int x, int y, T... components)
	{
	...
	//sets size of components
	public static <T extends JComponent> JPanel wrapInJPanelContainer(T component)
	{
