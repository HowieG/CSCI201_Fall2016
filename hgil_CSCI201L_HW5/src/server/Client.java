...
public class Client extends Thread
{
	...
	public void timerRanOut(String bogusMessage)
	{
		Message message = new QuestionAnsweredMessage(bogusMessage);
		actionFactory.getAction(QuestionAnsweredMessage.class).executeAction(mainGUI, gameData, message, this);
